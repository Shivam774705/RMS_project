...
SECRET_KEY = 'django-insecure-sq#pr*)_q$vna$lkdj2sr!0y@83@=67l%3kfyjf_4)6y(2%1(9'
...
# LOGIN_URL = '/accounts/login/'               # Redirect unauthenticated users to your login view at '/'
# LOGIN_REDIRECT_URL = '/index/' # Redirect users here after a successful login
